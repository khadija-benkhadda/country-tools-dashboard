...
function cleanPlaceResult(place: PlaceQuery, countryName: string) {
  const withoutZone = place.query.replace(/\s*·\s*zone\s+\d+\s*$/i, "").trim();
  return stripCountrySuffix(withoutZone, countryName);
}
